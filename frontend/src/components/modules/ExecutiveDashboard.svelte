...
<style>
  ...
  .gauge-label { color: #606060; font-size: 0.75rem; text-transform: uppercase; letter-spacing: 0.1em; }
  ...
  .sev-row { display: flex; align-items: center; gap: 8px; margin-bottom: 0.4rem; font-size: 0.82rem; }
  .sev-dot { width: 8px; height: 8px; border-radius: 50%; flex-shrink: 0; }
  .sev-name { color: #787878; flex: 1; }
  .sev-count { font-weight: 700; font-size: 0.9rem; }
  ...
  .host-ip { color: #f0f0f0; font-family: monospace; font-size: 0.88rem; font-weight: 600; margin-bottom: 0.35rem; }
  .host-meta { display: flex; gap: 0.75rem; font-size: 0.75rem; margin-bottom: 0.5rem; }
  .host-score { font-weight: 700; }
  .host-country { color: #606060; }
  ...
  .c2-title { color: #e03e5a !important; }
  .exfil-title { color: #d4622c !important; }
  .candidate-ip { font-family: monospace; font-size: 0.82rem; color: #909090; padding: 2px 0; }
</style>
